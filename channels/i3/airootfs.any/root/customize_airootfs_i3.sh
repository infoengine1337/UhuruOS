...
if [[ "${arch}" = "i686" ]]; then
    sed -i -e s/chromium/chromium/g "/etc/skel/.config/i3/config"
    sed -i -e s/chromium/chromium/g "/home/${username}/.config/i3/config"
fi
...
chmod 755 "/usr/bin/uhuru-system-menu"
