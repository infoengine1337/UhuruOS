# Thank you for try infoengine1337 UhuruOS i3 Edition
This document will show how to use infoengine1337 UhuruOS i3 Edition.  
このドキュメントでは、infoengine1337 UhuruOS i3エディションの使い方を紹介します。
...
## インストールされているi3wmについて
infoengine1337 UhuruOSでは，ウィンドウマネージャとしてi3wmからフォークされたi3-gapsがインストールされています。  
...
## テーマを変更する
mod+Shift+S で、infoengine1337 UhuruOS i3独自のテーママネージャを起動できます。  
...
## その他
- わからないことがある  
Known As [(@Fascode_SPT)](https://twitter.com/Fascode_SPT) へのDMや返信等で気軽に聞いてください。
...
infoengine1337 UhuruOS installed i3-gaps forked from i3wm as a window manager.  
...
## Change the theme
You can use mod+Shift+S to launch infoengine1337 UhuruOS i3's own theme manager.  
...
Feel free to ask by DM or reply to Known As [(@Fascode_SPT)](https://twitter.com/Fascode_SPT).


---

		infoengine1337 UhuruOS i3 edition help document
		Watasuke
		Known As: @Watasuke102
		Email  : Watasuke102@gmail.com
		(c) 2021 team-silencesuzuka